...
export default function ResetPassword() {
  ...
  if (!newPass || !confirmPass) {
    setSheet({
      title: 'Campos vacíos',
      message: 'Ingresa tu nueva contraseña en ambos campos.',
      confirmText: 'Cerrar',
      onConfirm: () => setShowSheet(false),
      variant: 'error',
    });
      ...
      <View style={s.wrap}>
        <View style={s.content}>
          <View style={s.iconCircle}>
            <Ionicons name="key-outline" size={32} color={C.textPrimary} />
          </View>
...
const s = StyleSheet.create({
  ...
  pwdWrap: { position: 'relative', width: '100%', marginBottom: 16 },
  input: { backgroundColor: '#0f0f0fff', borderWidth: 0, borderRadius: 10, paddingHorizontal: 16, height: 48, color: C.textPrimary, textAlign: 'center', width: '100%', paddingRight: 48 },
